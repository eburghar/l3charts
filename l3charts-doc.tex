...
Position of the label. Should be \texttt{left}, \texttt{right}, \texttt{above}, \texttt{below},
\texttt{above right}, \texttt{above left}, \texttt{below right} or  \texttt{below left}
