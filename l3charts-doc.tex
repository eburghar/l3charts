...
\NewDocumentCommand\redbold{m}{\textcolor{red!50}{\textbf{#1}}}
...
\Describe{Option}{fill-options}{:prop}[\{fill=none,draw=black!30\}]
\TikZ{} options to fill/draw the background with

\Describe{Option}{draw-options}{:prop}[\{fill=black,draw=none\}]
...
% show max as a dotted line
% and put labels in bold on the right
\begin{bubblechart}[
    vertical=true,
    label-cs=textbf,
    label-pos=right,
...
\DescribeMacro{redbold}
Macro used to format values
