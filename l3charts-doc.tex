...
\begin{kiviatchart}[scale=0.75]
  % we define all the dimensions of the charts, and specify the placement
...
Each set sets its own color and point shape.
...
\begin{verbatim}
% draw 5 circles bar hiding the circles
...
\begin{verbatim}
% format labels, fill in red, and show maximum dashed
